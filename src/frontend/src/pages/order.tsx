...
export function OrderPage() {
  ...
  return (
    <div className="p-6 lg:p-8">
      ...
      <SectionCard title="Order Information" icon={InfoIcon} className="mt-6">
        <OrderInfo order={order} />
      </SectionCard>

      {order.issue_tags.length > 0 && (
        <SectionCard title="Issue Tags" icon={TagIcon} className="mt-5">
      ...
      <SectionCard title="Email History" icon={EnvelopeSimpleIcon} className="mt-5">
        <EmailHistory emails={order.emails} />
      </SectionCard>

      {order.review && (
        <SectionCard title="Review Decision" icon={GavelIcon} className="mt-5">
